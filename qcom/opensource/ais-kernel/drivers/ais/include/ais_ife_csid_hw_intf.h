...
enum ais_ife_csid_cmd_type {
	...
	AIS_IFE_CSID_CMD_DIAG_INFO,
	AIS_IFE_CSID_CMD_MAX,
};

/**
 * enum ais_ife_pix_path_res_id - Specify the csid patch
 */
enum ais_ife_pix_path_res_id {
	AIS_IFE_PIX_PATH_RES_RDI_0,
	AIS_IFE_PIX_PATH_RES_RDI_1,
	AIS_IFE_PIX_PATH_RES_RDI_2,
	AIS_IFE_PIX_PATH_RES_RDI_3,
	AIS_IFE_PIX_PATH_RES_RDI_4,
	AIS_IFE_PIX_PATH_RES_IPP,
	AIS_IFE_PIX_PATH_RES_PPP,
	AIS_IFE_PIX_PATH_RES_UDI_0,
	AIS_IFE_PIX_PATH_RES_UDI_1,
	AIS_IFE_PIX_PATH_RES_UDI_2,
