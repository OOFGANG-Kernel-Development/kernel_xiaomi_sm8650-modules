...
static int ais_cci_core_process_read_cmd(struct v4l2_subdev *sd,
...
static int ais_cci_core_process_read_burst_cmd(struct v4l2_subdev *sd,
						struct cam_control *cmd,
						struct cam_cci_ctrl cci_ctrl)
{
	int rc = 0;
...
static int ais_cci_core_process_write_cmd(struct v4l2_subdev *sd,
						struct cam_control *cmd,
						struct cam_cci_ctrl cci_ctrl)
{
	int rc = 0;
...
static int ais_cci_core_process_write_burst_cmd(struct v4l2_subdev *sd,
						struct cam_control *cmd,
						struct cam_cci_ctrl cci_ctrl)
{
	int rc = 0;
...
int32_t ais_cci_core_cam_ctrl(struct v4l2_subdev *sd,
	void *arg)
{
	int32_t rc = 0;
	struct cci_device *cci_dev = v4l2_get_subdevdata(sd);
	...
	case AIS_SENSOR_I2C_READ:
		rc = ais_cci_core_process_read_cmd(sd, cmd, cci_ctrl);
		break;
	case AIS_SENSOR_I2C_READ_BURST:
		rc = ais_cci_core_process_read_burst_cmd(sd, cmd, cci_ctrl);
		break;
	case AIS_SENSOR_I2C_WRITE:
		rc = ais_cci_core_process_write_cmd(sd, cmd, cci_ctrl);
		break;
	case AIS_SENSOR_I2C_WRITE_BURST:
		rc = ais_cci_core_process_write_burst_cmd(sd, cmd, cci_ctrl);
		break;
