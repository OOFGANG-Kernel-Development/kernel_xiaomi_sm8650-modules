...
/**
 * @section: Type of pinctrl
 *
 * Declare the type of pinctrl
 */
 ...
 *
 * @brief: syna_hw_pct_data
 *         Hardware Data for pinctrl
 *
...
/*  The hardware data especially for pinctrl */
struct syna_hw_pct_data {
...
struct syna_hw_interface {
	 ...
	 *    0 on success; otherwise, on error.
	 */
	void (*ops_hw_reset)(struct syna_hw_interface *hw_if, int reset_delay_ms);
